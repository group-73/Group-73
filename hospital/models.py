...
class Assdoc_to_Doctor_Messages(models.Model):
    ...
    assdoctorId=models.PositiveIntegerField(null=True,blank=True)
    lab_report= models.FileField(upload_to='Lab_reports/Assdoc_to_Doctor/',null=True,blank=True)
...
class doc_to_Assdoc_Messages(models.Model):
    ...
    lab_report= models.FileField(upload_to='Lab_reports/doc_to_Assdoc/',null=True,blank=True)
    assdoc_name=models.CharField(max_length=255,null=True,blank=True)
