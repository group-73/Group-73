...
from .models import Doctor,Patient,assDoctor,Contact,Appointment,PatientDischargeDetails,admitrequest,dischargerequest,Assdoc_to_Doctor_Messages,doc_to_Assdoc_Messages
